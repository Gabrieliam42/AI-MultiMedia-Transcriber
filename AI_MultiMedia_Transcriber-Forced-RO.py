...
# Transcribe the audio using Whisper AI model, with Romanian as the fixed language
def transcribe_audio_file(audio_file):
    try:
        ...
        try:
            ...
            # Force the language to Romanian
            segments, info = model.transcribe(audio_file, language="ro")
            language_code = "ro"  # Manually set the language code to Romanian
            print(f"Transcribing with fixed language code: {language_code}")
